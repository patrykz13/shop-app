...
@Controller
public class PurchaseWithCreateAccountFrameController implements Initializable {
    ...
    void buttonConfirm_onAction() {
        ...
        if (name.isEmpty() && surname.isEmpty() && email.isEmpty() && phoneNumber.isEmpty() && street.isEmpty()
            ...
            showMessageBox(Alert.AlertType.INFORMATION, "Informacja",
                    "Utworzono konto użytkownika oraz sfinalizowano zamówienie.",
                    "Zapraszamy do kasy w celu dokonania płatności i odbioru produktów.\n" +
                            "Od teraz możesz również logować się do sklepu za pomocą swojego loginu i hasła\n" +
